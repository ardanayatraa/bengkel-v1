                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="level" id="level"
                            ...
                            <option value="Kasir" @selected($user->level == 'Kasir')>Kasir</option>
                        </select>
                    </div>
                    <div>
                        <label for="username"
                    ...
                    <div>
                        <label for="password" class="block font-medium text-gray-700 dark:text-gray-300 mb-2">Password
                            (Isi jika ingin ganti)</label>
