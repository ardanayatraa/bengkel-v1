                ...
                <thead>
                    <tr class="bg-gray-50">
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase border-b">NAMA
                            KONSUMEN</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase border-b">NAMA BARANG
                        </th>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase border-b">METODE
                            PEMBAYARAN</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase border-b">JUMLAH
                            POINT</th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse ($transaksis as $trx)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-2">{{ $trx->barang->nama_barang ?? '-' }}</td>
                            ...
                            <td class="px-6 py-2">{{ $trx->jumlah_point ?? 0 }}</td>
                        </tr>
                    @empty
                        <tr>
